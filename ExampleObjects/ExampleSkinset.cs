...
namespace FTKModLib.Example
{
    public class ExampleSkinset : CustomSkinset
    {
        public ExampleSkinset()
        {
            ...
            Avatar = MakeAvatar(ExampleMod.assetBundleSkins.LoadAsset<GameObject>("Assets/playerPaladin.prefab"));
            Armor = MakeArmor(ExampleMod.assetBundleSkins.LoadAsset<GameObject>("Assets/armorPaladin1.prefab"));
            Boot = MakeBoots(ExampleMod.assetBundleSkins.LoadAsset<GameObject>("Assets/bootsPaladin.prefab"));
